...
void Cheat::RenderInfo()
{
    ...
    String(ImVec2(8.f, 8.f), ImColor(1.f, 0.6f, 0.4f, 1.f), text.c_str());
    
    // watermark
    std::string watermark = "niggaballs1337";
    // 900.f, 8.f middle of screen
    String(ImVec2(900.f, 8.f), ImColor(1.f, 0.6f, 0.4f, 1.f), watermark.c_str());
