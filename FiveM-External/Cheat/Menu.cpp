...
{
    //ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(1.f, 0.6f, 0.4f, 1.f));
    //ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(1.f, 0.f, 0.f, 1.f));
    //ImGui::PushStyleColor(ImGuiCol_SliderGrab, ImVec4(1.f, 0.6f, 0.4f, 1.f));
    //ImGui::PushStyleColor(ImGuiCol_TitleBg, ImVec4(1.f, 0.6f, 0.4f, 1.f));
    //ImGui::PushStyleColor(ImGuiCol_ScrollbarBg, ImVec4(1.f, 0.6f, 0.4f, 1.f));
    //ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(1.f, 0.6f, 0.4f, 1.f));
    //ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(1.f, 1.f, 1.f, 1.f));
    ...
    ImGui::Begin("niggaballs1337", &g.ShowMenu, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
    ...
    case 0: // aim
        ...
        ImGui::SliderFloat("FOV", &g.AimFov, 10.f, 300.f);
        break;
    case 1: // visual
        ImGui::Text("Visual");
        ImGui::Separator();
